...
def move_robot():
    ...
    while not rospy.is_shutdown():
        ...
        if Posicion_x!=0:   #Posicion_x se inicializa en cero. Este valor debe cambiar cuando el robot empieza a moverse
            ...
            #Distancia_a_recorrer=distance_to_move+
                ...
                if Posicion_x>x_inicial+distance_to_move or Posicion_x<x_inicial-distance_to_move:
